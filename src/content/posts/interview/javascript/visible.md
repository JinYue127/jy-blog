...
![visible](../../../../assets/images/visible.png)
...
![visible2](../../../../assets/images/visible2.png)
...
属性对应的关系图如下所示：
![visible3](../../../../assets/images/visible3.png)
...
通过上述方式，可以看到可视区域颜色会变成黄色了，但是可以明显看到有卡顿的现象，原因在于我们绑定了`scroll`事件，`scroll`
